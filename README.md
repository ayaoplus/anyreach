...
| [**x**](docs/adapter-x.md) | x.com, twitter.com | 首页 timeline、搜索 timeline、用户主页 timeline、列表 timeline、普通推文、长文章。支持推文图片/视频，视频通过 CDP 网络事件恢复 `video.twimg.com` HLS 地址，文章输出 Markdown。 |
